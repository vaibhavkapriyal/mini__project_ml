...
for x in range(0,len(l1)):
    l2.append(0)                                                #all element of l2 becomes 0 till length of l1
                       ...
                       # TESTING DATA
test=pd.read_csv("https://raw.githubusercontent.com/vaibhavkapriyal/mini__project_ml/main/mini_project_disease_prediction-main/mini_project_disease_predictiction_ML/testing.csv")              #reading csv file by pd
...
# TRAINING DATA
train=pd.read_csv("https://raw.githubusercontent.com/vaibhavkapriyal/mini__project_ml/main/mini_project_disease_prediction-main/mini_project_disease_predictiction_ML/training.csv")
...
vaibhavGUI = Tk()
vaibhavGUI.title(" Disease Prediction Based on Symptoms")
vaibhavGUI.configure()
